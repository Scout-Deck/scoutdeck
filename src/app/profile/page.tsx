...
export default function Profile() {
  ...
  const form = useForm<ProfileForm>({ defaultValues: { name: '', educationLevel: '', fieldOfStudy: '', skills: '', interests: '', location: '', remoteOk: true, opportunityTypes: ['fellowship', 'builder_program'], experienceLevel: 'student' } });
